...
def inference(args):
    ...
    save_image(img, f'photos/{save_image_name}_1.png', nrow=8, normalize=True, scale_each=True)
    ...
    save_image(imgs, f'photos/{save_image_name}_2.png', nrow=16, normalize=True, scale_each=True)
